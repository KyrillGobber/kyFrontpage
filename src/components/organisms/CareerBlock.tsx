...
const getCareerItems = () => {
    return Experiences.map((experience, index) => {
        return (
            <CareerItem key={index} experience={experience} />
        );
    });
}
            ...
            <div>
                <Accordion type="single" collapsible>
                    <AccordionItem value="item-1">
                        <AccordionTrigger>{t('career.experienceDesc')}</AccordionTrigger>
                        <AccordionContent>
                            {t(experience.desc)}
                        </AccordionContent>
                    </AccordionItem>
                    <AccordionItem value="item-2">
                        <AccordionTrigger>{t('career.skillsAndTechstack')}</AccordionTrigger>
                        <AccordionContent>
